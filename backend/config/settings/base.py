...
# overrides should be defined in dev.py and prod.py.
# ======================================================================
...
# Read root-level .env if present; safe to skip in production
...
# In prod: DJANGO_DATABASE_URL is required
DATABASES = {
    "default": env.db(
        "DJANGO_DATABASE_URL",
...
REST_FRAMEWORK = {
    ...
    #   - API keys
    #   - OAuth2
    # without forcing a method before the system is ready.
    # "DEFAULT_AUTHENTICATION_CLASSES": [],

    # Permissions: require explicit configuration in each environment
    # (dev.py, prod.py, tests). This prevents accidental permissive defaults.
